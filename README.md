...
print(f"Input:{np.array([1, 1])}, Predicted: {predict_matrix(np.array([1, 1]), w)}")
```
![5 1](https://github.com/VINUTHNA-2004/Experiment-5-Implementation-of-XOR-using-RBF/assets/95067307/c746509e-3189-4c8e-8eba-63d0a245bbea)
```
mu1 = np.array([0, 0])
mu2 = np.array([1, 1])
...
print(f"Input:{np.array([1, 1])}, Predicted: {predict_matrix(np.array([1, 1]), w)}")
```
![5 2](https://github.com/VINUTHNA-2004/Experiment-5-Implementation-of-XOR-using-RBF/assets/95067307/3cdf5fcb-6cde-47e5-9aab-ce0666e53d44)
